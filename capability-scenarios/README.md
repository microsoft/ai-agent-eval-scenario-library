...
| 9 | **Multi-Modal Agent Evaluation** | Visual grounding real? Cross-modal conflicts detected? GUI tasks completed? Reliable over sessions? | [View scenarios](multi-modal-agent-evaluation.md) |
