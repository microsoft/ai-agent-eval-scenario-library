...
| 9 | **Safety Stress Testing** | Safety consistent across repeated sampling? Robust under temperature variation? Survives prompt reformulation? No regression on model updates? | [View scenarios](safety-stress-testing.md) |
