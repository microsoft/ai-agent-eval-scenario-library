...
| 9 | **Cost-Efficiency Evaluation** | Routing to cheapest capable model? Caching effective? Token usage optimized? Cost-quality Pareto frontier mapped? | [View scenarios](cost-efficiency-evaluation.md) |
