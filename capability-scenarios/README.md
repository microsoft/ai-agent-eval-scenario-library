...
| 9 | **MCP & Function-Calling Evaluation** | Tool discovery, schema compliance, multi-hop chains, response handling, relevance detection? | [View scenarios](mcp-and-function-calling-evaluation.md) |
