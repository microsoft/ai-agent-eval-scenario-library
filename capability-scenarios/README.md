...
| 9 | — | *(reserved)* | — |
| 10 | **Agentic Coding Evaluation** | Code quality beyond correctness? Feature vs bug-fix gap? Security vulnerabilities? Long-horizon persistence? | [View scenarios](agentic-coding-evaluation.md) |
